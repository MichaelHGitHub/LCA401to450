...
void PrintInput(TD_I_VVI_B testData);
void CheckResults(TD_I_VVI_B testData, bool result);
...
void PrintInput(TD_VI_I_I_B testData);
void CheckResults(TD_VI_I_I_B testData, bool result);
...
void PrintInput(TD_VI_VI_I_VVI testData);
void CheckResults(TD_VI_VI_I_VVI testData, vector<vector<int>> result);
void CheckResults_Unorder(TD_VI_VI_I_VVI testData, vector<vector<int>> result);
...
void PrintInput(TD_VI_VI_VI testData);
void CheckResults(TD_VI_VI_VI testData, vector<int> result);
...
void PrintInput(TD_I_VVI_VI testData);
void CheckResults(TD_I_VVI_VI testData, vector<int> result);
...
void PrintInput(TD_T_VS testData);
void checkResults(TD_T_VS testData, vector<string> result);
